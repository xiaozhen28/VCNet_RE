...
from processor import do_stage2
import random
import torch
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_file", default=os.path.join(WORK_DIR,"configs/VeRi/vcnet.yml"), help="path to config file", type=str)
    ...
    # model_view.load_param(cfg.TEST.WEIGHT_VIEW)
    do_stage2( # train id model 
        cfg,
        model_view,
        model,
        center_criterion,
