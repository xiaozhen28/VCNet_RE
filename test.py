...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_file", default=os.path.join(WORK_DIR,"configs/MCRI800/vit_base.yml"), help="path to config file", type=str
    )
    ...
    train_loader, train_loader_normal, query_loader,gallery_loader, num_query, num_classes, camera_num, view_num = make_dataloader(cfg)
